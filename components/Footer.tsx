      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-6">
          ...
          <ul className="flex flex-col gap-3">
            <li><Link className="text-white/55 hover:text-primary transition-colors" href="/method">Our Method</Link></li>
            ...
            <li><Link className="text-white/55 hover:text-primary transition-colors" href="/intelligence">Daily Brief</Link></li>
          </ul>
        </div>
        <div className="flex flex-col gap-6">
